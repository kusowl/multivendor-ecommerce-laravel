...
Route::post('/checkout/{cart}/payment/razorpay', [RazorPayController::class, 'create'])->name(
    'checkout.payment.razorpay',
);
Route::post('/checkout/payment/razorpay/verify', [RazorPayController::class, 'verify'])->name(

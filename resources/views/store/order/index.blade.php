    ...
    <div class="navbar bg-base-100 shadow-sm">
        <div class="flex-1">
            <a class="btn btn-ghost text-xl" href="#">
                <i class="fas fa-store mr-2"></i> ShopEasy
            </a>
        </div>
        <div class="flex-none">
            <div class="dropdown dropdown-end">
                ...
                <div tabindex="0" class="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-52 shadow">
                    <div class="card-body">
                        <span class="text-lg font-bold">3 Items</span>
                        <span class="text-info">Subtotal: $199.99</span>
            ...
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0"
                    ...
                    <li><a><i class="fas fa-user mr-2"></i> My Profile</a></li>
                    <li><a class="active"><i class="fas fa-box mr-2"></i> My Orders</a></li>
                    <li><a><i class="fas fa-heart mr-2"></i> My Wishlist</a></li>
    ...
    <div class="mx-auto max-w-6xl px-4 py-8">
        ...
        <div class="stats mb-8 w-full shadow">
            ...
            <div class="stat">
                ...
                <div class="stat-desc">Currently shipping</div>
            </div>
            ...
            <div class="stat">
                ...
                <div class="stat-desc">Successfully received</div>
            </div>
        </div>

                            ...
                            <div class="form-group">
                               <h4>Who are you?</h4>
                                <label class="radio-inline">
                                    <input type="radio" name="role" id="inlineRadio1" value="customer"><p>Customer</p>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="role" id="inlineRadio2" value="vendor"><p>Vendor</p>
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="role" id="inlineRadio3" value="partner"><p>Delivery Partner</p>
                                </label>
                                <div class="">
                                    <x-error field="role"/>
                                </div>
